! function() {
    ...
    function i() {
        return i = Object.assign || function(e) {
            for (var t = arguments.length, i = Array(t > 1 ? t - 1 : 0), o = 1;
 t > o;
 o++) i[o - 1] = arguments[o];
    ...
    function d(e, t) {
        ...
        return function() {
            ...
            for (var i = arguments.length, o = Array(i), r = 0;
 i > r;
 r++) o[r] = arguments[r];
    ...
    function C(e, t) {
        ...
        return f((a, s) => {
            if (n(s, t))
                ...
                for (let o = 0;
 n > o;
 o++) o in t[s] ? i[s][o] = t[s][o] : o in e[s] && (i[s][o] = e[s][o])
            } else i[s] = t[s];
 ...
 o++) n[o - 1] = arguments[o];
                ...
                return function() {
                    for (var t = arguments.length, o = Array(t), r = 0;
 t > r;
 r++) o[r] = arguments[r];
    ...
    let Kn = function(e) {
        ...
        return new Yn(n).then(e => {
            const n = e.on,
                o = e.call,
                r = function() {
                    for (var t = arguments.length, n = Array(t), i = 0;
 t > i;
 i++) n[i] = arguments[i];
            ...
            return t.resolveRemoteCall = e => {
                ...
                a.on(t, i), s[t] || (s[t] = !0, function() {
                    for (var t = arguments.length, i = Array(t), o = 0;
 t > o;
 o++) i[o] = arguments[o];
                ...
                for (var t = arguments.length, n = Array(t > 1 ? t - 1 : 0), i = 1;
 t > i;
 i++) n[i - 1] = arguments[i];
    ...
    function ii(e) {
        return ye(ti(e, e => Ke(e, "availability")), ge(b))
    }
    ...
    function ai(e, t) {
        return ye(we(e, "state_diff"), ke(() => Ke(e.state, "readyState")), ge(e => e === t), Oe(1), Pe)
    }
    ...
    function li(e, t) {
        return ye(ti(e, e => Ke(e, "invitation")), ke(e => e[t]), ge(b), Ae, ge(e => {
            let [t, n] = e;
    ...
    var vi = (e, t) => {
        ...
        ye(ti(e, e => Ke(e, "readyState")), ge(e => e === N), Oe(1), xe(() => ri(e)), ge(Boolean), he(() => {
            const {
                email: t,
                name: n
            } = Ge(e.state);
            ...
            const s = new BroadcastChannel(e.organizationId + (e.uniqueGroups && "number" == typeof e.group ? ":" + e.group : "") + ":detached_widget_visibility_broadcast_channel"),
                c = d(300, async function() {
                    ...
                    const o = Ve(t.state, "liveChatChatId").active,
                        s = "maximized" === Ke(t.state).visibility.state;
                    ...
                    window.documentPictureInPicture.requestWindow(l).then(e => {
                        ...
                        e.document.body.style.backgroundColor = Xt[s.theme.variant].widgetBackground, e.document.body.style.color = Xt[s.theme.variant].primaryTextColor, n.addEventListener("pagehide", () => {
                            ...
                            d.textContent = i("cancel"), d.style.backgroundColor = Xt[o.theme.variant].secondaryButtonBackground, d.style.color = Xt[o.theme.variant].primaryTextColor, a.append(s, c, l, d), e.document.body.append(a), e.document.body.addEventListener("click", e => {
 ...
 i++) n[i - 1] = arguments[i];
    ...
    function io(e, t, n) {
        return function(i) {
            ...
            const {
                trackerName: l
            } = t.analytics.googleAnalytics, d = !Xi(n.allowedDomains, document.location.href), u = [
 ...
 i++) n[i - 1] = arguments[i];
    ...
    const fo = {
            ...
            navigate(e, t) {
                void 0 === t && (t = "_blank"), Qn(() => {
                    window.location.origin === X(e) && "function" == typeof this.handler ? this.handler(ie(e)) : window.open(e, t)
                })
            }
        },
    ...
    function bo(e, t, n) {
        ...
        function p(t, n, o) {
            switch (n) {
                ...
                case "ready":
                    return void(Ke(e.state, "readyState") !== D ? Qn(() => o({
                        state: h("state"),
        ...
        function h(t) {
            switch (t) {
                ...
                case "features":
                    return c(Ke(e.state).config.features);
    ...
    var xo = e => {
            ...
            const i = () => {
                ...
                return t.content = "width=device-width, initial-scale=1.0, maximum-scale=1.0", Xe(ko, document.body), () => {
                    n = null, Xe(i, document.body), t.content = e, document.documentElement.scrollTop = r
                }
            };
        ...
        Oo = e => {
            ...
            const a = e => {
                ...
                s = t => {
                    ...
                    const i = null != (n = Ke(e.state).websiteTextSelection) ? n : {};
                ...
                l = () => {
                    const t = Ke(e.state).websiteTextSelection;
            ...
            ye(d, he(() => {
                ...
                i && (clearTimeout(i), i = null), o && (clearTimeout(o), o = null), r && (clearTimeout(r), r = null), null != (t = Ke(e.state).websiteTextSelection) && t.text && s({
                    text: "",
                    state: "hidden"
                })
            }))
        ...
        qo = (e, t, n, i, o, r, a, s, c) => {
            ...
            const f = {
                    ...
                    resize(t) {
                        ...
                        e.element.style.transition = s ? On : "none", Xe(T({}, c, l), e.element);
 ...
 i++) n[i - 1] = arguments[i];
        ...
        Wo = (e, t, n, i, o, r) => {
            e.call("storeMethod", ["setLocalization", i]), (e => {
                ...
                function(e, t, n) {
                    ...
                    St().then(t => {
                        e.call("shouldBridgeHandleAudio").then(n => {
                            n && (Ot.isBridgeActive = !0, e.on("add_event", n => {
                                ...
                                Ot.isBridgeActive && (Ke(e.state, "muted") || ((e, t) => "system" !== e.author && !e.properties.welcomeMessage && e.author !== t && "custom" !== e.type)(i, Ye(e.state)) && t(yt))
                            }), e.on("reaction_received", n => {
                                let {
                                    event: i
                                } = n;

                                Ot.isBridgeActive && (Ke(e.state, "muted") || Ye(e.state) === i.author && t(yt))
                            }))
                        })
                    })
                ...
                })(e) : (Co(e), "openwidget" === r && qn(e), Ki(e, r)), ji(e), "livechat" === r && ("documentPictureInPicture" in window && (e => {
                    var t;

                    return !!(null == (t = e.properties.license.bb9e5b2f1ab480e4a715977b7b1b4279) ? void 0 : t.detached_mode_enabled)
                })(o) && Di(t, e), (e => {
                    ye(ti(e, e => Ke(e).showTextSelectionTracking), ge(Boolean), Oe(1), he(() => {
                        Oo(e)
                    }))
                })(e), (e => {
                    const {
                    ...
                    const a = ye(ve(document, "visibilitychange"), ge(() => "maximized" === Ke(e.state).visibility.state), ke(() => !document.hidden));
            ...
            t.actingAsDirectLink || n.custom || function(e) {
                ...
                function(e) {
                    ...
                    const {
                        ...
                        Xe(Qe(["width"], t), t), requestAnimationFrame(() => {
                            Xe({
    ...
    var Vo = (e, t) => {
        ...
        Promise.all([h, "wix" === u ? $n() : jn(), et()]).then(e => {
            ...
            if (!Xi(o.allowedDomains, window.top === window ? window.location.hostname : document.referrer)) return void console.log("[LiveChat] Current domain is not added to the allowed domains. LiveChat has been disabled.");
            ...
            m.custom || a.appendChild(m.element), window.performance && "function" == typeof window.performance.mark && window.performance.mark("lc_bind_child"), Promise.all([qo(m, y, o, c, d, null, i, f, g), "openwidget" === i ? Promise.resolve(o.localization) : (b = {
                ...
                return m.custom || No(m.element), Wo(t, y, m, n, o, i), ye(ti(t, e => Ke(e, "readyState")), ge(e => e === N), Oe(1), ke(() => t), De)
            }).then(e => {
    ...
    function Ro() {
        et().then(e => {
            ["https://cdn.livechatinc.com/widget/static/js/configurator.rAvlPdK_.js"].forEach(t => {
                ((e, t) => {
